...
namespace LightSide
{
    ...
    public partial class UniText : IPointerClickHandler, IPointerDownHandler, IPointerUpHandler, IPointerEnterHandler, IPointerExitHandler, IPointerMoveHandler
    {
        ...
        private bool IsOverInteractiveRange(PointerEventData eventData)
        {
            ...
            var cam = canvas != null && canvas.renderMode != UnityEngine.RenderMode.ScreenSpaceOverlay
                ? canvas.worldCamera
                : null;

            var result = HitTestScreen(eventData.position, cam);
