...
namespace LightSide
{
    ...
    internal static class NativeFontReader
    {
        ...
        [DllImport("__Internal")]
        private static extern unsafe int UniText_ShapeEmojiRun(
            int* codepoints, int codepointCount, int fontSize,
            uint* outGlyphIds, int* outAdvances, int* outClusters,
            int maxOutput);

        internal static unsafe int ShapeEmojiRun(
            int* codepoints, int codepointCount, int fontSize,
            uint* outGlyphIds, int* outAdvances, int* outClusters,
            int maxOutput)
        {
            return UniText_ShapeEmojiRun(
                codepoints, codepointCount, fontSize,
